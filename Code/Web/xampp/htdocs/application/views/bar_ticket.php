...
$(function() {
		...
		$("input[name*='radio-']").change(
						...
						"Yes": function() {
								$( this ).dialog( "close" );
								 var spinner = $('#kright_center').spin();
								 	$.post("<?php echo base_url(); ?>index.php/bar/setDone",{ksid:ksid},
										function(data){
												spinner.spin('false');
			...
			$("button[id*='clear-']").click(function(){
									...
									function(data){
										$("#kitchen_header").find('img').fadeOut(300);
										//alert("debug");
...
<div style="margin:0px 10px;overflow:hidden;">
	...
	<button id="clear-<?php echo $data['sid'];?>"><?php echo $this->lang->line('msg_ClearCall');?></button>
</div>
<div id="kitchen_header" class="kitchen_header"></div>
